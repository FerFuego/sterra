...
class Usuarios {
    ...
    public function update() {
        $this->obj = new sQuery();
        $this->obj->executeQuery("UPDATE clientes SET Nombre = '$this->Nombre', Localidad = '$this->Localidad', Mail = '$this->Mail', Usuario = '$this->Usuario', Password = '$this->Password', ListaPrecioDef = $this->ListaPrecioDef, tipo = $this->tipo, is_Admin = $this->is_Admin WHERE (Id_Cliente = $this->Id_Cliente)");
    }
